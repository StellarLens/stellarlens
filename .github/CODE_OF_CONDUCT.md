...
message to the repository maintainer, or by opening a confidential report
through GitHub if available for this repository.

<!--
  TODO(maintainer): replace the paragraph above with a dedicated contact
  method (e.g. a project email address) before this project grows beyond a
  small group of maintainers who already know how to reach you.
-->
